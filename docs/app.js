...
(() => {
  ...
  const NAME_POOL = {
    PL: {first:['Jan','Kacper','Jakub','Mateusz','Piotr','Filip','Michał','Oskar','Szymon','Kamil','Łukasz','Andrzej','Marcin','Grzegorz','Tomasz','Paweł','Rafał','Dariusz','Krzysztof','Arkadiusz'],last:['Nowak','Kowalski','Wiśniewski','Wójcik','Kubiak','Kaczmarek','Kamiński','Lewandowski','Zieliński','Sikora','Bober','Piotrowski','Szymański','Górski','Krawczyk','Sawicki','Witkowski','Michalski','Borkowski','Kucharski']},
    NL: {first:['Daan','Luca','Bram','Finn','Sem','Tijn','Luuk','Sven','Milan','Davy','Tom','Rutger','Joost','Jeroen','Michiel','Pieter','Stefan','Wouter','Ylian','Bas'],last:['de Jong','Jansen','van Dijk','Bakker','Visser','Smit','de Vries','Mulder','Bos','Kuipers','Hendrix','Maes','Nijs','Ooms','Pauwels','Piters','Quaak','Rijs','Sels','Timmermans']},
    GB: {first:['Oliver','Harry','George','Noah','Jack','Charlie','Jacob','Alfie','Oscar','William','James','Benjamin','Ethan','Fredrick','Albert','Thomas','Arthur','Samuel','Edward','Mason'],last:['Smith','Brown','Taylor','Wilson','Evans','Johnson','Robinson','Walker','Wright','Green','Hall','Lewis','Harris','Martin','Perry','Phillips','Powell','Price','Pritchard','Quinn']},
    ES: {first:['Mateo','Hugo','Martín','Daniel','Pablo','Alejandro','Lucas','Adrián','Diego','Marco','Ignacio','Fernando','Javier','Manuel','Óscar','Antonio','Raúl','Sergio','Víctor','Enrique'],last:['García','Martínez','López','Sánchez','Pérez','González','Rodríguez','Fernández','Ruiz','Morales','Ramírez','Jiménez','Álvarez','Castillo','Flores','Cruz','Medina','Romero','Salas','Torres']},
    DE: {first:['Lukas','Leon','Finn','Jonas','Elias','Noah','Paul','Ben','Luis','Felix','Maximilian','Alexander','Florian','Fabian','Tobias','Sebastian','Julian','Christian','Daniel','Michael'],last:['Müller','Schmidt','Schneider','Fischer','Weber','Meyer','Wagner','Becker','Hoffmann','Koch','Bauer','Schäfer','Franke','Kaiser','Krause','Lange','Lauer','Lerner','Lesch','Lohr']},
    PT: {first:['João','Miguel','Rodrigo','Martim','Gonçalo','Tomás','Afonso','Diogo','Francisco','Duarte','António','Bartolomeu','Cristóvão','Damião','Estêvão','Fausto','Gregório','Hilário','Isidro','Jacinto'],last:['Silva','Santos','Ferreira','Pereira','Oliveira','Costa','Rodrigues','Martins','Lopes','Gomes','Sousa','Carvalho','Ribeiro','Almeida','Teixeira','Mendes','Nunes','Pinto','Rocha','Vaz']},
    IT: {first:['Matteo','Andrea','Luca','Marco','Davide','Riccardo','Giovanni','Alessandro','Antonio','Michele','Lorenzo','Giuseppe','Francesco','Claudio','Domenico','Emilio','Fabio','Gaetano','Giorgio','Girolamo'],last:['Rossi','Russo','Ferrari','Esposito','Bianchi','Romano','Colombo','Rizzo','Marino','Greco','Bruno','Gallo','Conti','De Luca','Costa','Giordano','Barbieri','Riccardi','Marchetti','Monti']},
    FR: {first:['Antoine','Matthieu','Quentin','Romain','Samuel','Théo','Valentin','Xavier','Yannick','Zacharie','Adrien','Bertrand','Christophe','Denis','Étienne','Fabrice','Gaston','Henri','Ignace','Jérôme'],last:['Dupont','Martin','Bernard','Thomas','Robert','Richard','Petit','Durand','Leroy','Moreau','Simon','Laurent','Lefebvre','Michel','García','David','Bertrand','Roux','Vincent','Fournier']},
    AR: {first:['Matías','Santiago','Juan','Martín','Facundo','Bruno','Ignacio','Lucas','Agustín','Tomás','Andrés','Ariel','Bernardo','Claudio','Damián','Ezequiel','Fabián','Gregorio','Herminio','Hilario'],last:['González','Rodríguez','Gómez','Fernández','López','Sosa','Pérez','Romero','Díaz','García','Martínez','Torres','Rivera','Cruz','Morales','Gutiérrez','Herrera','Jiménez','Castillo','Navarro']},
    BR: {first:['Miguel','Arthur','Davi','Heitor','Bernardo','Gabriel','Lucas','Enzo','Gustavo','Pedro','Alexandre','Antônio','Benedito','Carlos','Diogo','Eduardo','Fábio','Geovani','Henrique','Inácio'],last:['Silva','Santos','Oliveira','Souza','Ferreira','Pereira','Gomes','Ribeiro','Almeida','Martins','Costa','Rocha','Barbosa','Carvalho','Neves','Machado','Monteiro','Fonseca','Teixeira','Vargas']},
    CN: {first:['Wei','Hao','Lei','Jie','Ming','Jun','Tao','Huan','Qiang','Liang','Ang','Ben','Cang','Deng','Fang','Gang','Hui','Jian','Kang','Lun'],last:['Wang','Li','Zhang','Liu','Chen','Yang','Zhao','Huang','Zhou','Xu','Sun','Zhu','Lin','Guo','He','Gao','Zheng','Tang','Xu','Han']},
    ZA: {first:['Liam','Noah','Ethan','Logan','Daniel','Jayden','Ryan','Tyler','Jordan','Kyle','Amahle','Bongani','Cebile','Dlamini','Enoch','Fezile','Gcinile','Hloniphile','Indlulamithi','Jabulani'],last:['Nkosi','Dlamini','Nkuna','Mthethwa','van der Merwe','Botha','Smith','Mabuza','Mokwena','Khumalo','Ngubane','Ndaba','Nxumalo','Sithole','Mthembu','Magubane','Mkhize','Zuma','Thabane','Mahlangu']},
  };
  ...
  function generatePotential() {
    ...
    // Rozkład: 40% common (30-50), 45% normal (51-80), 15% rare (81-99)
    if (rand < 0.40) {
      return randInt(30, 50); // Common
    } else if (rand < 0.85) {
      return randInt(51, 80); // Normal
    } else {
      return randInt(81, 99); // Rare
    }
  }
